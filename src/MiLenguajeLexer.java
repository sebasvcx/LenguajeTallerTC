...
public class MiLenguajeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "FUNCION", "RETORNAR", 
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 31:
			return IDENT_sempred((RuleContext)_localctx, predIndex);
		}
		return true;
	}
	private boolean IDENT_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
